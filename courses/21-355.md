...
<!-- lean-dep-figure -->
<!-- figure-caption: Lean module dependencies for the 21-355 solution. Amber box: Mathlib imports. Blue box: solution modules. -->
```mermaid
...
flowchart LR
  ...
  subgraph ML["Mathlib"]
    ...
    LAlgebraOrderArchimedeanRealBasic["Algebra.Order.Archimedean.Real.Basic"]:::mathlib
    LAlgebraOrderGroupAbs["Algebra.Order.Group.Abs"]:::mathlib
    LDataIntBasic["Data.Int.Basic"]:::mathlib
    LDataRealBasic["Data.Real.Basic"]:::mathlib
    LDataSetFiniteBasic["Data.Set.Finite.Basic"]:::mathlib
    LOrderConditionallyCompleteLatticeBasic["Order.ConditionallyCompleteLattice.Basic"]:::mathlib
    LOrderFilterAtTopBotBasic["Order.Filter.AtTopBot.Basic"]:::mathlib
    LOrderIntervalFinsetDefs["Order.Interval.Finset.Defs"]:::mathlib
    LOrderIntervalFinsetNat["Order.Interval.Finset.Nat"]:::mathlib
    LOrderIntervalSetBasic["Order.Interval.Set.Basic"]:::mathlib
    LOrderLatticeNat["Order.Lattice.Nat"]:::mathlib
    LTacticByContra["Tactic.ByContra"]:::mathlib
    LTacticLinarith["Tactic.Linarith"]:::mathlib
    LTacticNormNum["Tactic.NormNum"]:::mathlib
    LTacticRing["Tactic.Ring"]:::mathlib
    LTopologyDefsFilter["Topology.Defs.Filter"]:::mathlib
    LTopologyMetricSpaceBasic["Topology.MetricSpace.Basic"]:::mathlib
    LTopologyOrderCompact["Topology.Order.Compact"]:::mathlib
    LTopologyOrderMonotoneConvergence["Topology.Order.MonotoneConvergence"]:::mathlib
    LTopologySequences["Topology.Sequences"]:::mathlib
  ...
  subgraph SOL["Solution modules"]
    ...
    MAltSeqDiverges["AltSeqDiverges"]:::course
    MAltSeqValues["AltSeqValues"]:::course
    MBolzanoWeierstrass["BolzanoWeierstrass"]:::course
    MCompactIcc["CompactIcc"]:::course
    MCompleteness["Completeness"]:::course
    MLimsupLiminfExist["LimsupLiminfExist"]:::course
    MMonotoneConvergence["MonotoneConvergence"]:::course
    MNumerical["Numerical"]:::course
    MPeakPoints["PeakPoints"]:::course
    MTailExtremes["TailExtremes"]:::course
  end

  LTacticRing --> MAltSeqDiverges
  LTacticLinarith --> MAltSeqDiverges
  LTopologyDefsFilter --> MAltSeqDiverges
  LOrderFilterAtTopBotBasic --> MAltSeqDiverges
  LTopologyMetricSpaceBasic --> MAltSeqDiverges
  LTopologyOrderMonotoneConvergence --> MAltSeqDiverges
  LOrderLatticeNat --> MAltSeqDiverges
  MAltSeqValues --> MAltSeqDiverges
  LDataRealBasic --> MAltSeqValues
  LTacticNormNum --> MAltSeqValues
  LTopologyOrderCompact --> MBolzanoWeierstrass
  LTopologySequences --> MBolzanoWeierstrass
  LAlgebraOrderGroupAbs --> MBolzanoWeierstrass
  MPeakPoints --> MBolzanoWeierstrass
  MMonotoneConvergence --> MBolzanoWeierstrass
  LOrderIntervalSetBasic --> MCompactIcc
  LTopologyUniformSpaceReal --> MCompactIcc
  LDataRealBasic --> MCompactIcc
  LTopologyOrderCompact --> MCompactIcc
  LOrderConditionallyCompleteLatticeBasic --> MCompleteness
  LAlgebraOrderArchimedeanRealBasic --> MCompleteness
  LDataRealBasic --> MCompleteness
  LTopologyDefsFilter --> MLimsupLiminfExist
  LOrderFilterAtTopBotBasic --> MLimsupLiminfExist
  LTopologyUniformSpaceReal --> MLimsupLiminfExist
  MTailExtremes --> MLimsupLiminfExist
  LTopologyDefsFilter --> MMonotoneConvergence
  LOrderFilterAtTopBotBasic --> MMonotoneConvergence
  LTopologyUniformSpaceReal --> MMonotoneConvergence
  LTopologyOrderMonotoneConvergence --> MMonotoneConvergence
  MCompleteness --> MMonotoneConvergence
  LDataIntBasic --> MNumerical
  LOrderIntervalFinsetNat --> MPeakPoints
  LOrderIntervalFinsetDefs --> MPeakPoints
  LDataSetFiniteBasic --> MPeakPoints
  LOrderIntervalSetBasic --> MPeakPoints
  LDataRealBasic --> MPeakPoints
  LTacticByContra --> MPeakPoints
  LTopologyOrderMonotoneConvergence --> MTailExtremes
  LOrderConditionallyCompleteLatticeBasic --> MTailExtremes
  LAlgebraOrderArchimedeanRealBasic --> MTailExtremes
  LDataRealBasic --> MTailExtremes
```
<!-- /lean-dep-figure -->
...
<!-- lean: BSinMeasurementTheory/Course21355/Completeness.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/MonotoneConvergence.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/PeakPoints.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/TailExtremes.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/LimsupLiminfExist.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/AltSeqValues.lean -->
...
<!-- lean: BSinMeasurementTheory/Course21355/AltSeqDiverges.lean -->
