...
flowchart LR
  ...
  subgraph ML["Mathlib"]
    ...
    LOrderFilterBasic["Order.Filter.Basic"]:::mathlib
    LOrderLiminfLimsup["Order.LiminfLimsup"]:::mathlib
    LTacticLinarith["Tactic.Linarith"]:::mathlib
    LTacticNormNum["Tactic.NormNum"]:::mathlib
    LTopologyCompactnessCompact["Topology.Compactness.Compact"]:::mathlib
  end
  ...
  LOrderFilterBasic --> MAltSeqDiverges
  LTacticLinarith --> MAltSeqDiverges
  MAltSeqValues --> MAltSeqDiverges
  LDataRealBasic --> MAltSeqValues
  LTacticNormNum --> MAltSeqValues
  LDataRealBasic --> MBolzanoWeierstrass
  LOrderFilterBasic --> MBolzanoWeierstrass
  LTopologyCompactnessCompact --> MBolzanoWeierstrass
  LDataRealBasic --> MCompactIcc
  LTopologyCompactnessCompact --> MCompactIcc
  LOrderFilterBasic --> MLimsupLiminfExist
  MTailExtremes --> MLimsupLiminfExist
  LDataIntBasic --> MNumerical
  LDataRealBasic --> MTailExtremes
  LOrderLiminfLimsup --> MTailExtremes
```
<!-- /lean-dep-figure -->
