...
<!-- lean-dep-figure -->
<!-- figure-caption: Lean module dependencies for the 21-322 solution. Amber box: Mathlib imports. Blue box: solution modules. -->
```mermaid
...
flowchart LR
  ...
  subgraph SOL["Solution modules"]
    ...
    MAtomIso["AtomIso"]:::course
    MHom["Hom"]:::course
    MMeasureCollapse["MeasureCollapse"]:::course
    MNumerical["Numerical"]:::course
    MStoneClopen["StoneClopen"]:::course
  end

  LTacticByContra --> MAtomIso
  MHom --> MAtomIso
  LDataFintypeBasic --> MHom
  LAlgebraBigOperatorsGroupFinsetBasic --> MHom
  LDataRealBasic --> MMeasureCollapse
  MStoneClopen --> MMeasureCollapse
  LAlgebraBigOperatorsFin --> MNumerical
  LTacticNormNum --> MNumerical
  MMeasureCollapse --> MNumerical
  MHom --> MStoneClopen
```
<!-- /lean-dep-figure -->
