...
<!-- lean-dep-figure -->
<!-- figure-caption: Lean module dependencies for the 21-321 solution. Amber box: Mathlib imports. Blue box: solution modules. -->
```mermaid
...
flowchart LR
  ...
  subgraph ML["Mathlib"]
    ...
    LAlgebraBigOperatorsPi["Algebra.BigOperators.Pi"]:::mathlib
    ...
    LAlgebraOrderRingDefs["Algebra.Order.Ring.Defs"]:::mathlib
    LDataFinVecNotation["Data.Fin.VecNotation"]:::mathlib
    LDataFinsetBasic["Data.Finset.Basic"]:::mathlib
    LDataFintypeFin["Data.Fintype.Fin"]:::mathlib
    LDataNatCastOrderRing["Data.Nat.Cast.Order.Ring"]:::mathlib
  ...
  subgraph SOL["Solution modules"]
    ...
    MKraft["Kraft"]:::course
    MScottPair["ScottPair"]:::course
    MTheorem11["Theorem11"]:::course
    MTheorem12["Theorem12"]:::course
    MTheorem13["Theorem13"]:::course
  end

  LTacticFinCases --> MKraft
  LTacticNormNum --> MKraft
  LDataFinVecNotation --> MKraft
  LDataFintypeFin --> MKraft
  LAlgebraBigOperatorsPi --> MKraft
  MScottPair --> MKraft
  MTheorem11 --> MKraft
  LDataFinsetBasic --> MScottPair
  LAlgebraModuleLinearMapBasic --> MScottPair
  LAlgebraOrderRingDefs --> MScottPair
  LAlgebraBigOperatorsGroupFinsetBasic --> MScottPair
  LDataRealBasic --> MTheorem11
  LAlgebraOrderBigOperatorsGroupFinset --> MTheorem11
  LTacticLinarith --> MTheorem11
  MScottPair --> MTheorem11
  LDataNatCastOrderRing --> MTheorem12
  LAlgebraOrderBigOperatorsGroupFinset --> MTheorem12
  LTacticLinarith --> MTheorem12
  LDataRatDefs --> MTheorem12
  MScottPair --> MTheorem12
  LAlgebraBigOperatorsRingFinset --> MTheorem13
  MScottPair --> MTheorem13
  MTheorem12 --> MTheorem13
```
<!-- /lean-dep-figure -->
