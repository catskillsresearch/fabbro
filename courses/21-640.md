...
flowchart LR
  ...
  subgraph ML["Mathlib"]
    ...
    LTacticAbel["Tactic.Abel"]:::mathlib
    ...
    LTopologyContinuousMapAlgebra["Topology.ContinuousMap.Algebra"]:::mathlib
  ...
  subgraph SOL["Solution modules"]
    ...
    MApplyHahnBanach["ApplyHahnBanach"]:::course
    MDominance["Dominance"]:::course
    MNormSublinear["NormSublinear"]:::course
    MNumerical["Numerical"]:::course
    MPositiveExtension["PositiveExtension"]:::course
    MPositivity["Positivity"]:::course
    MPreciseStatement["PreciseStatement"]:::course
    MRoleOfSublinear["RoleOfSublinear"]:::course
    MScott41["Scott41"]:::course
    MSublinear["Sublinear"]:::course
  end

  MPreciseStatement --> MApplyHahnBanach
  MDominance --> MApplyHahnBanach
  MNormSublinear --> MApplyHahnBanach
  LAlgebraModuleLinearMapBasic --> MDominance
  MNormSublinear --> MDominance
  LTacticRing --> MNormSublinear
  LTacticLinarith --> MNormSublinear
  MSublinear --> MNormSublinear
  LTacticPositivity --> MNumerical
  LTacticLinarith --> MNumerical
  LDataRealBasic --> MNumerical
  LTacticRing --> MNumerical
  MApplyHahnBanach --> MPositiveExtension
  MPositivity --> MPositiveExtension
  LTacticLinarith --> MPositivity
  LAlgebraModuleLinearMapBasic --> MPositivity
  MSublinear --> MPositivity
  LAlgebraModuleLinearMapBasic --> MPreciseStatement
  MSublinear --> MPreciseStatement
  LTacticAbel --> MRoleOfSublinear
  LTacticLinarith --> MRoleOfSublinear
  LAlgebraModuleLinearMapBasic --> MRoleOfSublinear
  MSublinear --> MRoleOfSublinear
  LTopologyContinuousMapBasic --> MScott41
  LTopologyBasic --> MScott41
  LTopologyContinuousMapAlgebra --> MScott41
  MPositiveExtension --> MScott41
  LAlgebraModuleBasic --> MSublinear
  LDataRealBasic --> MSublinear
  LAnalysisNormedModuleBasic --> MSublinear
```
<!-- /lean-dep-figure -->
